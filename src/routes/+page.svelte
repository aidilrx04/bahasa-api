<script>
	let host = 'http://bahasa-api.vercel.app';
...
<main>
	...
	<section>
		...
		<p>
			...
			need. If you found any error or problem using this application, please report it to the <a
				href={GITHUB_REPO_URL}>{GITHUB_REPO_URL}</a
			>
		</p>
	</section>
</main>
